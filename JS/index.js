...
getWeather("cairo")
  function  display(){
    ...
    let month = startDate.toLocaleDateString('en-EG', { month: 'long' });
       ...
       <div class="col-lg-10 col-sm-12 card2 text-black  " >
    ...
    <i class="fa-solid fa-umbrella my-1 "></i>
<p>20%</p>
</div>
<div  class="d-flex gap-1  ">
...
<div class="half row d-flex gap-5 mx-auto mt-5 ">
    <div class="col-lg-5 col-sm-12 card2 text-black">
